...
Frozen 2026-08-30. Bibliographic metadata was checked against publisher pages,
DOI records, or the issuing institution. Every entry below is used in the paper.
...
: Publisher metadata checked at Cambridge Core; supports systemic-risk decomposition.
...
: Publisher metadata checked at Elsevier; supports rare-event sampling.
...
: Publisher metadata checked at Nature; supports model and tail uncertainty.
...
: Publisher metadata checked at Elsevier; supports multilayer-network notation.
...
: Publisher article checked at Nature; supports recursive cross-network failure.
...
: Publisher metadata checked at Princeton University Press; supplies the historical framing whose transfer limits are stated in the paper.
...
: Publisher metadata checked at Nature; supports correlated breadbasket risk.
...
: Publisher article checked at Nature; supports regional crop-response forcing and its aggregate scale.
...
: Current official manual checked 2026-08-30; supplies famine evidence thresholds.
...
: Official AR6 WGII report checked at IPCC; supports compound, cascading, and transmitted risk.
...
: Publisher article checked at PNAS and PubMed Central; supports the research gap, not a probability estimate.
...
: Publisher article checked at Nature; supports synchronized-yield model discrepancy.
...
: Publisher PDF checked at Nature; supports trade, restriction, and policy-response channels.
...
: Publisher metadata checked at Elsevier; supports interaction effects and the bounded historical analogy.
...
: Official report checked at National Academies Press; supports factual-counterfactual attribution.
...
: Publisher metadata checked at IOP; supports time-varying trade-network vulnerability.
...
: Official UN source checked; supplies the 2024 population denominator.
...
: Official WHO source checked; supports the nutrition-disease interaction.
...
: Publisher article checked at Nature; supplies a non-transferable structural analogue for integrated food-shock modeling.
